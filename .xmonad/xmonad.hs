...
-- LAYOUT ICONS
iStart = " ^bg(" ++ "#313131" ++ ")^fg(" ++ "#FFFfFf" ++ ")" ++ " " ++ wIcons1
iSep = ""
...
wColor handle = def
  ...
  , ppVisible           = dzenColor "#FFFFFF" "#000000" . pad . wrap  " "  " "
  , ppCurrent           = dzenColor "#000000" "#FFFFFF" . pad . wrap  " "  " "
  , ppHidden            = dzenColor "#FFFFFF" "#000000" . pad . wrap  " "  " "
  , ppHiddenNoWindows   = dzenColor "#444444" "#000000" . pad . wrap  " "  " "
  , ppSep               = "   "
...
myKeys = [
  ...
  , ((mod4Mask, xK_d), spawn  "dmenu_run -b -i -l 3 -p 'MENU: ' -fn 'Exo 2:size=12' -nb '#000000' -nf '#FFFFFF' -sb '#FFFFFF' -sf '#000000' ")
...
-- STATUS BAR
myRightBar  = "sleep 1;conky -c $HOME/.xmonad/bar | dzen2 -p -ta r -fn 'Exo 2:size=10' -fg '#FFFFFF' -bg '#000000' -x 880 -h 30 -w 1350"
myLeftBar   = "sleep 1;dzen2 -p -ta l -fn 'Exo 2:size=10' -fg '#FFFFFF' -bg '#000000' -h 30 -w 900"
